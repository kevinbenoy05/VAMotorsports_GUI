...
class ELECHOUSE_CC1101
{
	public:
		...
		static void SpiMode(byte config);
		static byte SpiTransfer(byte value);
		static void GDO_Set (void);
		static void Reset (void);
		static void SpiWriteReg(byte addr, byte value);
		static void SpiWriteBurstReg(byte addr, byte *buffer, byte num);
		static void SpiStrobe(byte strobe);
		static byte SpiReadReg(byte addr);
		static void SpiReadBurstReg(byte addr, byte *buffer, byte num);
		static byte SpiReadStatus(byte addr);
		static void RegConfigSettings(void);
	public:
		void Init(void);
