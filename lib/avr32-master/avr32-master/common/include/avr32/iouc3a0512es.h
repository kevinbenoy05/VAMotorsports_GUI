 ...
 *  
 * This file describes the properties of the Atmel UC3A0512ES
 ...
 * File name:           UC3A0512ES.xml
 * File version:        0
 * File release status: RELEASE
 * Last file update:    2007-02-06
 *
...
#ifndef __IOUC3A0512ES_H
#define __IOUC3A0512ES_H

#if (!__AAVR32__ && !__ICCAVR32__)
#error "File iouc3a0512es.h is for use with ICCAVR32/AAVR32 only."
#endif
