 ...
 *  
 * This file describes the properties of the Atmel UC3A1512ES
...
#ifndef __IOUC3A1512ES_H
#define __IOUC3A1512ES_H

#if (!__AAVR32__ && !__ICCAVR32__)
#error "File iouc3a1512es.h is for use with ICCAVR32/AAVR32 only."
#endif
