 ...
 *  
 * This file describes the properties of the Atmel UC3A3128S
 ...
 * File name:           uc3a3128s.xml
 * File version:        0
 * File release status: RELEASE
 * Last file update:    2007-11-21
 *
...
#ifndef __IOUC3A3128S_H
#define __IOUC3A3128S_H

#if (!__AAVR32__ && !__ICCAVR32__)
#error "File iouc3a3128s.h is for use with ICCAVR32/AAVR32 only."
#endif
...
/* DAC - Audio Bitstream DAC */

/* Interrupts */

#define AVR32_DAC_IRQ_GROUP           19
