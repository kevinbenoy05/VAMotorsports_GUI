 ...
 *  
 * This file describes the properties of the Atmel UC3A3256
...
#ifndef __IOUC3A3256_H
#define __IOUC3A3256_H

#if (!__AAVR32__ && !__ICCAVR32__)
#error "File iouc3a3256.h is for use with ICCAVR32/AAVR32 only."
#endif
